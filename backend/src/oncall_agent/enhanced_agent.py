...
class EnhancedPagerAlert(BaseModel):
    ...
    incident_start_time: Optional[str] = None  # When the issue actually started
    detection_delay: Optional[int] = None  # Minutes between start and detection
    ...
    def _format_analysis_for_claude(self, analysis: Dict[str, Any]) -> str:
        ...
        if "commit_timeline" in analysis:
            ...
            if timeline_analysis.get("fix_commits"):
                formatted_parts.append(f"- Recent fix commits:")
