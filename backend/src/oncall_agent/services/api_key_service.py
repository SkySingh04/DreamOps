...
class APIKeyService:
    ...
    def __init__(self, storage_path: str = None):
        ...
        self.storage_path = storage_path or os.path.join(
            os.path.expanduser("~"), ".dreamops", "api_keys.json"
        )
    ...
    def get_actual_key(self, key_id: str) -> Optional[str]:
    ...
    def update_key(self, key_id: str, update_data: APIKeyUpdate) -> Optional[APIKey]:
        """Update an API key."""
    ...
    def get_active_key(self) -> Optional[tuple[str, str, LLMProvider]]:
    ...
    def get_next_fallback_key(self) -> Optional[tuple[str, str, LLMProvider]]:
    ...
    def get_settings(self) -> Optional[APIKeySettings]:
