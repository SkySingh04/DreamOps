...
from src.oncall_agent.api.schemas import AIMode, RiskLevel
...
class AgentExecutor:
    ...
    def __init__(self, k8s_integration: Optional[KubernetesMCPServerIntegration] = None):
    ...
    async def _execute_increase_memory(self, action: ResolutionAction, auto_approve: bool) -> dict[str, Any]:
        ...
        patch_cmd = [
            ...
            "-n", params["namespace"],
            "--type", "json",
            "-p", f'[{{"op": "replace", "path": "/spec/template/spec/containers/0/resources/limits/memory", "value": "512Mi"}}]'
        ]
